...
while count < arrLen:
    ...
    count += 1
set1ProcessedJSON = SVR.SVR_process_monotypeAlt(set1DictList)
...
rawDataZ = list(map(lambda x:x["val"]["data"][2], set1DictList))
...
processedZ = list(map(lambda x:x["data"][2], processedData))
